...
from Sadchenko_Mykyta.workshop4.source import app, db
from Sadchenko_Mykyta.workshop4.source.models import (
		User, Note, UserNoteParams
	)
from Sadchenko_Mykyta.workshop4.source.forms import (
		NoteForm,
		UserForm,
		UserNoteParamsForm,
		RegisterForm,
...
def db_session_delete(query, del_id, message=''):
	try:
		del_item = session.query(query).get(del_id)
