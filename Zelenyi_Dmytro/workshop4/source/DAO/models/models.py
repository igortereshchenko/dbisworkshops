...
class contacts(Base):
    ...
    @classmethod
    def add(cls, email=None, phone_number=None, instagram=None, facebook=None, skype=None, telegram=None):
        Session = sessionmaker(bind=engine)
        session = Session()
...
class serveces(Base):
    ...
    @classmethod
    def add(cls, email, object_shooting=None, portrait_shooting=None, wedding_photo_shoot=None, family_photo_shot=None,
            event_photography=None, reportage_shooting=None, childrens_photo_shoot=None, interior_shooting=None,
            photosession_love_story=None, pregnant_photoshoot=None, neither=None):
        Session = sessionmaker(bind=engine)
        session = Session()
...
# photographers.add("fasfas@gmail.com", "qwerty", "Admin", "Male", "I'm cool", 3, "Soup", "Soup", "Y", birthday=datetime.datetime(1994, 5, 21), photographer_surname="Adminov")
# contacts.add(email="fasfas@gmail.com", phone_number='380979125124')
# serveces.add(email="fasfas@gmail.com", event_photography=15, pregnant_photoshoot=999)
